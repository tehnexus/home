...
public class TableButtonColumn extends AbstractCellEditor
	...
	public void actionPerformed(ActionEvent e) {
		...
		ActionEvent event = new ActionEvent(table, ActionEvent.ACTION_PERFORMED, e.getActionCommand(), 0, row);
