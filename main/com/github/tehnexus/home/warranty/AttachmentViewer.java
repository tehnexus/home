...
import org.tehnexus.filetypedetector.FileType;
import org.tehnexus.filetypedetector.FileTypeDetector;
...
import org.tehnexus.image.SizeFit;
import org.tehnexus.image.listeners.ImageAdapter;
import org.tehnexus.image.listeners.MouseWheelImageListener;
...
public class AttachmentViewer extends JDialog {
	...
	private void init(Attachment attach) throws IOException, SQLException {
	...
	private void updateImage(SizeFit fitTo) {
		...
		Dimension windowSizeNew = new Dimension(imgSize.getWidth() + contentMargin.getWidth(),
...
//
//			// resize window
//			windowSizeNew = new Dimension(imgSize.getWidth() + contentMargin.getWidth(),
//					imgSize.getHeight() + contentMargin.getHeight());
//			setSize(windowSizeNew);
